...
!function(a,u,n){var h=a();a.fn.dropdownHover=function(s){return"ontouchstart"in document?this:(h=h.add(this.parent()),this.each(function(){var e,o=a(this),t=o.parent(),n={delay:a(this).data("delay"),instantlyCloseOthers:a(this).data("close-others")},r="show.bs.dropdown",i=a.extend(!0,{},{delay:500,instantlyCloseOthers:!0},s,n);function d(n){760<a(document).width()&&(h.find(":focus").blur(),!0===i.instantlyCloseOthers&&h.removeClass("open"),u.clearTimeout(e),t.addClass("open"),o.trigger(r))}t.hover(function(n){if(!t.hasClass("open")&&!o.is(n.target))return!0;d(n)},function(){768<a(document).width()&&(e=u.setTimeout(function(){t.removeClass("open"),o.trigger("hide.bs.dropdown")},i.delay))}),o.hover(function(n){if(!t.hasClass("open")&&!t.is(n.target))return!0;d(n)}),t.find(".dropdown-submenu").each(function(){var e,o=a(this);o.hover(function(){u.clearTimeout(e),o.children(".dropdown-menu").show(),o.siblings().children(".dropdown-menu").hide()},function(){var n=o.children(".dropdown-menu");e=u.setTimeout(function(){n.hide()},i.delay)})})}))},a(document).ready(function(){a('[data-hover="dropdown"]').dropdownHover()})}(jQuery,this);
