...
@section('content')
    <div class="page-title">
        <div class="title_left">
            <h3><?=($this->uri->segment(2) == 'add') ? 'Add ' : 'Edit '?>Kategori</h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><?=($this->uri->segment(2) == 'add') ? 'Add ' : 'Edit '?>Kategori</h2>
                    ...
                    <form class="form-horizontal form-label-left" id="myForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                value="<?=isset($kategori['kategori'])?$kategori['kategori']:set_value('kategori');?>" required>
                            </div>
                        </div>
